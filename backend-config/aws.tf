...
# TODO Improve permission based on documentation
...
data "aws_iam_policy_document" "terraform_s3_list_read_write_policy_document" {
  statement {
    ...
    resources = [
      aws_s3_bucket.terraform_state_s3_bucket.arn,
      "${aws_s3_bucket.terraform_state_s3_bucket.arn}/organization/github-terraform-example/terraform.tfstate"
    ]
  }
}
